...
public class MenuBar {
    ...
    private JMenu menu1 = new JMenu("Edition");
    private JMenu menu2 = new JMenu("Aide");
    private JMenuItem menu0Item0 = new JMenuItem("Ouvrir");
    private JMenuItem menu1Item0 = new JMenuItem("Créer un sommet");
    ...
    private void menu1Item0ActionPerformed(java.awt.event.ActionEvent evt) {
        List<Sommet> listeSommets = gui.getListeSommets();
        Graph g = gui.getG();
        ...
        if (result == JOptionPane.OK_OPTION) {
            GraphPanel graphPanel = swingContainer.getGraphPanel();
